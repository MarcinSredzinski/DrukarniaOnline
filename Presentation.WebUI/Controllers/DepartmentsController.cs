...
namespace Presentation.WebUI.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        IReposotoryBase<Department> _departmentRepository;

        public DepartmentsController(DrukarniaDbContext context, IReposotoryBase<Department> departmentRepository)
        {
            _context = context;
